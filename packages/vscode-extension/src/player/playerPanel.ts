...
import type { ExtensionToWebviewMessage, WebviewToExtensionMessage } from "../tts/types.js";
import { getNonce, getPlayerHtml } from "./playerHtml.js";
...
export class PlayerPanel {
  ...
  private messageHandlers: Map<string, (msg: WebviewToExtensionMessage) => void> = new Map();
   ...
   */
  onMessage(type: string, handler: (msg: WebviewToExtensionMessage) => void): void {
